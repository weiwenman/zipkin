...
public final class GaussDBStorage extends StorageComponent {
  ...
  public static final class Builder extends StorageComponent.Builder {
    ...
    @Override
    public GaussDBStorage build() {
      return new GaussDBStorage(this);
    }
  ...
  GaussDBStorage(Builder builder) {
  ...
  public SpanStore spanStore() {
    return new GaussDBSpanStore(this, schema());
  }
  ...
  public AutocompleteTags autocompleteTags() {
    return new GaussDBAutocompleteTags(this, schema());
  }

  @Override
  public SpanConsumer spanConsumer() {
    return new GaussDBSpanConsumer(dataSourceCallFactory, schema());
  }
  ...
  public final String toString() {
    return "GaussDBStorage{datasource=" + datasource + "}";
  }

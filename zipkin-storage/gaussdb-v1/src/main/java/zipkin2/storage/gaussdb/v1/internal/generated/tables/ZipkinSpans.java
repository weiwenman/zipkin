...
import zipkin2.storage.gaussdb.v1.internal.generated.Keys;
...
public class ZipkinSpans extends TableImpl<Record> {
    ...
    /**
     * The column <code>public.zipkin_spans.trace_id_high</code>.
     */
     ...
     */
    public final TableField<Record, String> DEBUG = createField(DSL.name("debug"), SQLDataType.CHAR(1), this, "");

    /**
     * The column <code>public.zipkin_spans.start_ts</code>.
     */
    public final TableField<Record, Long> START_TS = createField(DSL.name("start_ts"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.zipkin_spans.duration</code>.
     */
    public final TableField<Record, Long> DURATION = createField(DSL.name("duration"), SQLDataType.BIGINT, this, "");

...
public class ZipkinAnnotations extends TableImpl<Record> {
    ...
    /**
     * The column <code>public.zipkin_annotations.span_id</code>. coincides with
     * zipkin_spans.id
     */
     ...
     */
    public final TableField<Record, String> A_VALUE = createField(DSL.name("a_value"), SQLDataType.VARCHAR(2000), this, "BinaryAnnotation.value(), which must be smaller than 64KB");
    ...
    /**
     * The column <code>public.zipkin_annotations.a_timestamp</code>. Used to
    ...
    /**
     * The column <code>public.zipkin_annotations.ipv4</code>. Null when
     * Binary/Annotation.endpoint is null
     */
    public final TableField<Record, String> IPV4 = createField(DSL.name("ipv4"), SQLDataType.VARCHAR(255), this, "Null when Binary/Annotation.endpoint is null");

    /**
     * The column <code>public.zipkin_annotations.ipv6</code>. Null when
     * Binary/Annotation.endpoint is null, or no IPv6 address
     */
    public final TableField<Record, String> IPV6 = createField(DSL.name("ipv6"), SQLDataType.VARCHAR(255), this, "Null when Binary/Annotation.endpoint is null, or no IPv6 address");

    /**
     * The column <code>public.zipkin_annotations.port</code>. Null when
     * Binary/Annotation.endpoint is null
     */
    public final TableField<Record, Short> PORT = createField(DSL.name("port"), SQLDataType.SMALLINT, this, "Null when Binary/Annotation.endpoint is null");

    /**
     * The column <code>public.zipkin_annotations.service_name</code>. Null when
     * Binary/Annotation.endpoint is null
     */
    public final TableField<Record, String> SERVICE_NAME = createField(DSL.name("service_name"), SQLDataType.VARCHAR(255), this, "Null when Binary/Annotation.endpoint is null");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.ZIPKIN_ANNOTATIONS_INDEX_SPAN_ID_A_KEY_ID);
    }

    @Override
    public List<UniqueKey<Record>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_ZIPKIN_ANNOTATIONS_SPAN_ID_A_KEY);
    }

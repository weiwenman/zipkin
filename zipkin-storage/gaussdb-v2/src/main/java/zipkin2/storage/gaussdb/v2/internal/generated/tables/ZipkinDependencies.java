...
public class ZipkinDependencies extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> PARENT = createField(DSL.name("parent"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>public.zipkin_dependencies.child</code>.
     */
    public final TableField<Record, String> CHILD = createField(DSL.name("child"), SQLDataType.VARCHAR(32).nullable(false), this, "");
    ...
    public List<UniqueKey<Record>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_ZIPKIN_DEPENDENCIES_DAY);
    }
